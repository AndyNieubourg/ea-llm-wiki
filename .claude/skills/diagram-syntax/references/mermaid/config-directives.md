<!-- Vendored verbatim from tractorjuice/arc-kit, plugins/arckit-claude/skills/mermaid-syntax/references/config-directives.md (MIT). -->
<!-- ArcKit sourced it from WH-2099/mermaid-skill, itself autogenerated from mermaid.js.org docs. -->
<!-- Refresh from upstream rather than hand-editing. -->
> **Warning**
>
...
- ~~*htmlLabels*~~: Deprecated, [prefer setting this at the root level](/config/schema-docs/config#htmllabels).
- *curve*: linear/curve
