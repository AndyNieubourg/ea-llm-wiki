...
(only when the                                       (only when it carries an
 piece has an                                         argument or a
 argument to structure)                               recommendation)
```
